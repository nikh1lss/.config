...
export PATH="$HOME/bin:$HOME/.local/bin:$HOME/.cargo/bin:/usr/local/bin:/usr/local/go/bin:$PATH"
...
# Powerlevel theme (need MesloLGS NF) ZSH_THEME="powerlevel10k/powerlevel10k"
...
[ -f "/home/nikhil/.ghcup/env" ] && . "/home/nikhil/.ghcup/env" # ghcup-env
